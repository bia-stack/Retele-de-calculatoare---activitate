...
# In-memory file operation history: {filename: [entries]}
file_history = {}


def record_history(filename, operation, user='unknown'):
        ...
        while True:
            ...
            try:
                ...
                # File operations
                    ...
                    record_history(filename, 'create', current_user)
                    ...
                    if not os.path.exists(old_path):
                        ...
                        record_history(new_name, f'rename from {old_name} to {new_name}', current_user)
                    ...
                    if not os.path.exists(filepath):
                        ...
                        with open(filepath, 'r') as f:
                            content = f.read()
                        record_history(filename, 'read', current_user)
                    ...
                    if not os.path.exists(filepath):
                        ...
                        response = {'status': 'success', 'content': content, 'filename': filename}
                    ...
                    if not os.path.exists(filepath):
                        ...
                        with open(filepath, 'w') as f:
                            f.write(new_content)
                        record_history(filename, 'edit', current_user)
